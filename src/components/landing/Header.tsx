            ...
            <div className="flex flex-col items-center justify-center relative z-20 shrink-0">
              <div className="bg-gradient-to-br from-gray-900 to-black border-[3px] border-gray-600/80 px-4 py-1.5 rounded-xl shadow-[inset_0_3px_15px_rgba(0,0,0,0.9),_0_2px_5px_rgba(255,255,255,0.8)] flex items-center gap-4 justify-center">
                ...
                <div className="flex items-start">
                  <span className="text-[#22d3ee] font-mono text-xl md:text-2xl font-bold tracking-widest leading-none drop-shadow-[0_0_10px_rgba(34,211,238,0.8)]">
                    {loading ? "18" : (temp !== null ? temp : "18")}
                  </span>
              ...
              {navLinks.map((link, index) => {
                ...
                return (
                  <motion.button
                    ...
                    className={`px-3 py-1.5 text-[12px] font-bold rounded-lg transition-all border shadow-sm ${isActive
                  ...
                  {navLinks.map((link, index) => {
                    ...
                    return (
                      <motion.button
                        key={link.name}
                        onClick={() => handleNavClick(link.href)}
                        className={`text-center transition-all font-bold py-3 px-4 rounded-xl active:scale-95 border ${isActive
                          ? "bg-slate-200 border-slate-300 text-slate-800 shadow-[inset_0_2px_4px_rgba(0,0,0,0.1)]"
